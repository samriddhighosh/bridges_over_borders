  ...
  return (
    <div className="flex flex-col gap-12 justify-center items-center mx-auto font-onest bg-white text-black">
      ...
      <div className="text-center items-center lg:w-3/4 py-24 bg-white">
        ...
        <h1 className="font-abhayaLibre text-[64px] lg:text-[72px] leading-[60px] lg:leading-[66px] pb-3 text-[#1E2967] font-medium w-3/4 mx-auto tracking-tight">Contact Our Community!</h1>
