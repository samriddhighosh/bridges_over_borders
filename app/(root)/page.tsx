...
export default function Home() {
  return (
    ...
    <div className="flex flex-col gap-12 justify-center items-center mx-auto font-onest bg-white text-black">
      ...
      <div className="justify-center items-center mx-auto px-6 lg:px-20 flex flex-col gap-20 w-10/12">
        ...
        <div className="lg:flex gap-12">
          <Image alt="Image represneting immigration" width={300} height={300} src="https://litiligroup.com/wp-content/uploads/2024/08/diversity-6-1024x683.jpg" className="bg-gray-200 lg:w-2/4 h-[280px] rounded-xl"/>
          <div className="lg:w-3/5 align-middle self-center">
